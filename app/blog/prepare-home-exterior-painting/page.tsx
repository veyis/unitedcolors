...
export const metadata: Metadata = {
  ...
  description: 'Learn how to properly prepare your home for exterior painting with this step-by-step guide from United Color Painters.',
  openGraph: {
    title: 'How to Prepare Your Home for Exterior Painting | United Color Painters',
    description: 'Follow our expert tips to ensure your home is ready for a professional exterior painting job. Proper preparation is key to a long-lasting finish.',
  },
}
      ...
      <main className="flex-grow">
        <article className="py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold mb-6">How to Prepare Your Home for Exterior Painting</h1>
            <p className="text-gray-600 mb-8">Published on February 1, 2024</p>
            <img src="/images/blog/prepare-home-exterior-painting.jpg" alt="Home Exterior Preparation for Painting" className="w-full h-96 object-cover rounded-lg mb-8" />
            <div className="prose max-w-none">
              <p>Preparing your home's exterior for painting is crucial for achieving a long-lasting, professional-looking finish. At United Color Painters, we always emphasize the importance of proper preparation. Here's a step-by-step guide to help you get your home ready for its new coat of paint.</p>
              ...
              <div className="bg-blue-100 p-6 rounded-lg mt-8">
                ...
                <p>For the best results, consider hiring professional painters like United Color Painters. We have the experience, tools, and expertise to properly prepare your home's exterior and apply paint for a flawless, long-lasting finish.</p>
              </div>

              <h2>Ready to Transform Your Home's Exterior?</h2>
              <p>Proper preparation is key to a successful exterior painting project. If you're ready to give your home a fresh new look, contact United Color Painters today. Our team of experts will ensure your home's exterior is properly prepared and painted to perfection.</p>
            </div>
            <div className="mt-8">
